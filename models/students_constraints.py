...
class Studentnotavailable(models.Model):
    ...
    weight_percent = fields.Float('Weight Percentage', default=100)
    ...
    max_hr_daily = fields.Integer('Max Hours Daily For All Students', size=10)
    min_hr_daily = fields.Integer('Min Hours Daily For All Students', size=10)
    max_hr_cont_act = fields.Integer(
        'Max Hour Continously with Activity For All Students', size=10)
    max_hr_cont = fields.Integer(
    ...
    max_hr_daily_act = fields.Integer(
